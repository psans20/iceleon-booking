...
export default function Hex({ display }) {
    ...
    return (
        <div className={`margin-0 z-0 h-screen flex items-center justify-center ${!display ? '' : 'hidden'} ${clock ? 'bg-transparent' : 'bg-white'} transition-all ease-out duration-300`}>
            <svg id="hexContainer" className="shrink" width="240px" height="240px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <path
                        pathLength="10"
                        id="Hexigon"
